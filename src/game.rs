...
impl Default for Deck {
    fn default() -> Self {
        Deck {
            cards: Rank::iter()
                .flat_map(|r| Suit::iter().map(move |s| Card { suit: s, rank: r }))
                .collect(),
        }
    }
}
